 ...
 */
const underline2camelcase = (obj, deep = true, separator = '_') => {
    return transform({
        obj,
        deep,
        separator,
...
exports.underline2camelcase = underline2camelcase;
/**
 ...
 */
const camelcase2underline = (obj, deep = true, separator = '') => {
    return transform({
        obj,
        deep,
        separator,
...
exports.camelcase2underline = camelcase2underline;
